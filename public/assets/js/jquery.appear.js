...
! function(a) {
    a.fn.appear = function(e, r) {
        ...
        return this.each(function() {
            ...
            var n = a(window),
                t = function() {
                    ...
                    var a = n.scrollLeft(),
                        ...
                        l = r.width(),
                        d = n.width();
                    i + s + o >= e && i <= e + h + o && c + l + f >= a && c <= a + d + f ? r.appeared || r.trigger("appear", p.data) : r.appeared = !1
                },
                c = function() {
            ...
            p.one ? r.one("appear", p.data, c) : r.bind("appear", p.data, c), n.scroll(t), a.fn.appear.checks.push(t), t()
        })
