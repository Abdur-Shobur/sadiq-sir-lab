    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('dashboard.team-categories.update', $teamCategory) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                           id="title" name="title" value="{{ old('title', $teamCategory->title) }}" required>
                                    @error('title')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror"
                                              id="description" name="description" rows="4">{{ old('description', $teamCategory->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="border rounded p-3" style="max-height: 300px; overflow-y: auto;">
                                        @if($availableTeams->count() > 0)
                                            ...
                                            <div class="row" id="team-members-container">
                                                ...
                                                <div class="col-md-6 mb-3 team-member-row" data-team-id="{{ $team->id }}"
                                                     style="display: {{ in_array($team->id, old('team_members', $teamCategory->teams->pluck('id')->toArray())) ? 'block' : 'none' }};">
                                                    <div class="card">
                                                        <div class="card-body p-3">
                                                            <div class="form-check mb-2">
                                                                <input class="form-check-input team-member-checkbox" type="checkbox"
                                                                       ...
                                                                       id="team_{{ $team->id }}"
                                                                       {{ in_array($team->id, old('team_members', $teamCategory->teams->pluck('id')->toArray())) ? 'checked' : '' }}>
                                                                <label class="form-check-label d-flex align-items-center" for="team_{{ $team->id }}">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        @if($team->category_id == $teamCategory->id)
                                                                            <small class="text-success">(Current member)</small>
                                                                        @endif
                                                                    </div>
                                                                </label>
                                                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror"
                                           id="sort_order" name="sort_order" value="{{ old('sort_order', $teamCategory->sort_order) }}" min="0">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                               value="1" {{ old('is_active', $teamCategory->is_active) ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize sort previews for existing values
    sortOrderInputs.forEach(input => {
        if (input.value) {
            updateSortPreview(input);
        }
