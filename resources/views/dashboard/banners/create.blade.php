                    ...
                    <form action="{{ route('dashboard.banners.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('action_button_text') is-invalid @enderror"
                                   id="action_button_text" name="action_button_text" value="{{ old('action_button_text') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('action_button_link') is-invalid @enderror"
                                   id="action_button_link" name="action_button_link" value="{{ old('action_button_link') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Supported formats: JPG, PNG, GIF, SVG, WebP. Max size: 2MB (Optional)</div>
                            @error('banner_image')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
