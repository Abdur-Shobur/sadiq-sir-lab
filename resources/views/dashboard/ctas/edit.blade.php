...
<div class="mt-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Edit CTA</li>
        </ol>
    </nav>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="cta-preview">
                                            <h3 id="preview-title" class="mb-2">{{ $cta->title }}</h3>
                                            <p id="preview-description" class="text-muted small">{{ $cta->description }}</p>
                                            <h2 class="mb-3"><a href="tel:{{ $cta->phone_number }}" id="preview-phone">{{ $cta->phone_number }}</a></h2>
                                            <a href="#" class="btn btn-primary" id="preview-button">{{ $cta->button_text }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
