                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('background_color') is-invalid @enderror"
                                                ...
                                                <option value="bg-default" {{ old('background_color', $researchArea->background_color) == 'bg-default' ? 'selected' : '' }}>Default</option>
                                                ...
                                                <option value="bg-007bff" {{ old('background_color', $researchArea->background_color) == 'bg-007bff' ? 'selected' : '' }}>Blue</option>
                                                <option value="bg-6c757d" {{ old('background_color', $researchArea->background_color) == 'bg-6c757d' ? 'selected' : '' }}>Gray</option>
                                                <option value="bg-dc3545" {{ old('background_color', $researchArea->background_color) == 'bg-dc3545' ? 'selected' : '' }}>Red</option>
                                            </select>
