...
@section('title', 'Create Research Area')
...
<div class="container-fluid mt-4">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Create Research Area</li>
        </ol>
    </nav>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4>Create New Research Area</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('dashboard.research-areas.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">Create Research Area</button>
                        </div>
                    </form>
                </div>
            </div>
